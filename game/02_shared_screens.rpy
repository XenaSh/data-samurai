...
label chat_with_sasha:
    ...
    if sasha_phase == 0:
        ...
        sasha "Первое задание позади. Не идеально, но и без пожара."
    elif sasha_phase == 2:
...
label sasha_investigation:
    ...
    if sasha_phase == 1:
        ...
        sasha "Может, ничего. А может — то, что у него личный интерес. Он вообще редко интересуется чем-то лично."
