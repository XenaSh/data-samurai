...
label task2:
    ...
    player "Видите колебания на графике?"
    boss "Ну?"
...
label task2_q1:
    ...
    "Ты задерживаешься ещё на мгновение, чтобы точно прикинуть, где находятся пики относительно известного тебе дня..."
    hide image "images/revenue_and_load.png"
    ...
    menu:
        "Понедельник":
            ...
            player "Раздобыли уже земные календари, получается?"
            boss "Просто здравый смысл."
        ...
        "Суббота":
            $ task2_q1_attempts += 1
            window show
            boss "Нет, и это объяснимо. Ты бы сам сказал мне, как аналитик, что в выходные дни нагрузка обычно падает, разве нет?"
            if task2_q1_attempts == 2:
                boss "Ты издеваешься? Подумай ещё раз."
            elif task2_q1_attempts >= 3:
                boss "Серьёзно? Числа повторяются каждые семь дней. Просто посчитай от известной даты."
...
label task2_q2:
    ...
    player "Я просто пытаюсь соотнести эту переодичность с моими предыдущими размышлениями..."
