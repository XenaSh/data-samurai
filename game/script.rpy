...
screen chat_icon_prompt():
    ...
    timer 5.0 action If(_chat_icon_line < 1, true=SetVariable("_chat_icon_line", 1))
...
label sasha_milaya_boltovnya:
    ...
    player "Можешь не шутить пять минут, пока я пытаюсь думать, ИИ с потугами в юмор?"
    "..."
...
label task1:
    ...
    "Первым делом ты видишь, что данные аномизированные — вместо ID магазинов или их адресов всего лишь буквы. Каждой буквой соответсвует строка с показателями."
...
label chart_trick_demo:
    sasha "Вот, гляди, что мне сегодня подсунули."
    ...
    sasha "Вот именно на такую реакцию всё и рассчитано. Смотри, я в таких случаях всегда проверяю три места. Первое — заголовок."
